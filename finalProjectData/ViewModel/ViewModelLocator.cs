...
namespace Employee.Data.ViewModel
{
	/// <summary>
	...
	{
		public const string EmployeeListPageKey = "NoteListPage";
		public const string EmployeeDetailPageKey = "NoteDetailPage";
		/// <summary>
		...
		public EmployeeListViewModel NoteList
		{
			get
			{
		...
		public EmployeeDetailViewModel NoteDetail
		{
			get
			{
